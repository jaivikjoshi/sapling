...
Map<String, dynamic> recurringIncomesCompanionToSupabase(
  RecurringIncomesCompanion c,
  String userId,
) {
  final m = <String, dynamic>{'user_id': userId};
  if (c.id.present) m['id'] = c.id.value;
...
Map<String, dynamic> personsCompanionToSupabase(
  PersonsCompanion c,
  String userId,
) {
  final m = <String, dynamic>{'user_id': userId};
...
Map<String, dynamic> splitEntriesCompanionToSupabase(
  SplitEntriesCompanion c,
  String userId,
) {
  final m = <String, dynamic>{'user_id': userId};
  if (c.id.present) m['id'] = c.id.value;
...
Map<String, dynamic> dailyCloseoutsCompanionToSupabase(
  DailyCloseoutsCompanion c,
  String userId,
) {
  final m = <String, dynamic>{'user_id': userId};
  if (c.id.present) m['id'] = c.id.value;
...
Map<String, dynamic> recoveryPlansCompanionToSupabase(
  RecoveryPlansCompanion c,
  String userId,
) {
  final m = <String, dynamic>{'user_id': userId};
  if (c.id.present) m['id'] = c.id.value;
