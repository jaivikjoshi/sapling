  ...
  static ThemeData get light {
    ...
    return ThemeData(
      ...
      textTheme: const TextTheme(
        ...
        bodyLarge: TextStyle(fontSize: 16, color: LekoColors.textPrimary),
        bodyMedium: TextStyle(fontSize: 14, color: LekoColors.textSecondary),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide: const BorderSide(color: LekoColors.secondary, width: 1.5),
        ),
      ),
      ...
      textButtonTheme: TextButtonThemeData(
        style: TextButton.styleFrom(foregroundColor: LekoColors.secondary),
      ),
